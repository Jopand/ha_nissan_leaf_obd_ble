...
from ..metrics import ZE1_ODOMETER_COMMAND, ZE1_ODOMETER_EXPECTED_BYTES
...
leaf_commands = {
    ...
    "display_state_of_charge": OBDCommand("display_state_of_charge", "Dashboard/display state of charge", b"03221204",    0,  display_state_of_charge, header=b"797",),
    ...
    "odometer":              OBDCommand("odometer",              "Total odometer reading (km)",         ZE1_ODOMETER_COMMAND, ZE1_ODOMETER_EXPECTED_BYTES, odometer, header=b"743",),
    ...
    "range_remaining":       OBDCommand("range_remaining",       "Remaining range (km)",                b"03220e24",    0,  range_remaining,        header=b"743",),
    "lbc":                   OBDCommand("lbc",                   "Li-ion battery controller",           b"022101",      53, lbc,                    header=b"79B",),
    "odometer_can":          OBDCommand("odometer_can",         "Total odometer reading (km) from CAN broadcast 0x5C5", b"5C5",         8,  odometer_can_broadcast, can_monitor=True,),
}
# fmt: on
